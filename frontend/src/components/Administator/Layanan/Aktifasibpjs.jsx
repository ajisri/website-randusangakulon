...
const Aktifasibpjs = () => {
  ...
  const [pname, setPname] = useState("aktifasibpjs");
  const [aktifasibpjsContent, setAktifasibpjsContent] = useState("");
  ...
  useEffect(() => {
    if (data?.service) {
      ...
      setAktifasibpjsContent(data.service.content);
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("aktifasibpjsContent", aktifasibpjsContent);
