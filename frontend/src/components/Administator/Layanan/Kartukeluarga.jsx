...
const Kartukeluarga = () => {
  ...
  const [pname, setPname] = useState("kartukeluarga");
  const [kartukeluargaContent, setKartukeluargaContent] = useState("");
  ...
  useEffect(() => {
    if (data?.service) {
      ...
      setKartukeluargaContent(data.service.content);
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("kartukeluargaContent", kartukeluargaContent);
